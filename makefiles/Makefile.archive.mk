...
$(INSTALL_DIR)$(ARCHIVE_EXT): archive_cc archive_dotnet archive_java
...
ortools$Sdotnet$S$(ORTOOLS_FSHARP_DLL_NAME)$S$(ORTOOLS_FSHARP_DLL_NAME).fsproj
	...
	$(COPY) bin$SGoogle.Protobuf.dll $(TEMP_ARCHIVE_DIR)$S$(INSTALL_DIR)$Sbin
# ToDo copy examples
#	$(MKDIR_P) $(TEMP_ARCHIVE_DIR)$S$(INSTALL_DIR)$Sexamples$Sexamples$Sdotnet
#	$(COPYREC) examples$Sdotnet $(TEMP_ARCHIVE_DIR)$S$(INSTALL_DIR)$Sexamples
